...
.shell{max-width:1120px;margin:0 auto;padding:44px 28px 60px}
...
.result-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));margin:0;border-top:1px solid var(--line)}
.result-grid>div{padding:var(--space-6) 0;border-bottom:1px solid var(--line)}
.result-grid>div:nth-child(odd){padding-right:var(--space-8)}
.result-grid>div:nth-child(even){padding-left:var(--space-8);border-left:1px solid var(--line)}
...
.method-copy p{margin:0 0 var(--space-4)}.source{overflow-wrap:anywhere;color:var(--muted);font-size:14px}
footer{padding:var(--space-8) 0;color:var(--muted);font-size:13px}
@media(max-width:767px){.shell{padding:24px 14px 40px}.hero{grid-template-columns:1fr;gap:var(--space-10);padding:var(--space-12) 0}.section-heading,.method{grid-template-columns:1fr;gap:var(--space-3)}.result-grid{grid-template-columns:1fr}.result-grid>div:nth-child(odd),.result-grid>div:nth-child(even){padding:var(--space-6) 0;border-left:0}.headline-result{padding:var(--space-6)}section{padding:var(--space-12) 0}.chart{padding:var(--space-3)}h1{font-size:29px}}
