...
def add_framework_arguments(parser: argparse.ArgumentParser) -> None:
...
FRAMEWORK_SCENARIO = ScenarioEntry(
    name="framework",
    description="Run the framework backtest (DCA vs drawdown timing strategies)",
    add_arguments=add_framework_arguments,
    run=run_framework,
)

SCENARIO_REGISTRY.register(FRAMEWORK_SCENARIO)
